...
(function() {
    ...
    RED.nodes.registerType('debug',{
        ...
        onpaletteadd: function() {
            ...
            // Register as tab but it will be handled specially by sidebar
            RED.sidebar.addTab({
                id: "debug",
            ...
            // Set debug panel in lower section
            RED.sidebar.setDebugPanel({
                content: uiComponents.content,
                toolbar: uiComponents.footer,
                icon: "fa fa-bug",
                label: this._("debug.sidebar.label")
            ...
            RED.actions.add("core:show-debug-tab",function() {
                // Panel is always visible, just focus on it
                $("#red-ui-sidebar-debug-content").focus();
            });
