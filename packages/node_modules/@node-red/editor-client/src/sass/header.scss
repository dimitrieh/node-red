...
#red-ui-header {
    position: absolute;
    top: 0; /* Header at the top of the page */
    left: 0;
    width: 100%;
    ...
    padding-top: 2px;
    position: relative; /* Needed for absolute positioned center search */
    ...
    // Center section for palette search - using absolute positioning to avoid affecting button layout
    .red-ui-header-center {
        position: absolute;
        left: 50%;
        top: 50%;
        ...
        .red-ui-palette-search {
            ...
            input {
                ...
                &::placeholder {
                    color: var(--red-ui-form-input-placeholder-color);
                }
            }
        }
    }
