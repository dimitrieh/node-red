...
// Mobile-first responsive header optimizations
@media screen and (max-width: 768px) {
    #red-ui-header {
        height: var(--red-ui-mobile-header-height);
        padding: var(--red-ui-mobile-spacing-sm) var(--red-ui-mobile-spacing-md);
        
        .button {
            @include mixins.touch-target;
            @include mixins.mobile-smooth-transition;
            @include mixins.mobile-tap-highlight;
            padding: var(--red-ui-mobile-spacing-sm) var(--red-ui-mobile-spacing-md);
            margin: 0 var(--red-ui-mobile-spacing-xs);
            border-radius: 8px;
        ...
        .red-ui-deploy-button-group {
            #red-ui-header-button-deploy {
                @include mixins.touch-target-large;
                font-size: 16px;
                font-weight: 600;
    ...
    // Hide secondary text elements on small screens
    ...
    #red-ui-header {
        .red-ui-header-toolbar {
            ...
            .button {
                ...
                .red-ui-deploy-button-content > span:not(.fa) {
                    display: none;
                }
            }
        }
...
@media screen and (min-width: 768px) and (max-width: 1024px) {
    #red-ui-header {
        height: var(--red-ui-tablet-header-height);
