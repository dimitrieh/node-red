...
#red-ui-header {
    ...
    @media screen and (max-width: 768px) {
        padding: 0px 10px 0px 10px; // Less side padding on mobile
        height: 56px; // Taller header for better touch targets
        font-size: 16px; // Larger text for mobile
    }
    
    @media screen and (max-width: 480px) {
        padding: 0px 8px; // Even less padding on small phones
        height: 60px; // Extra tall on small phones
    }
    ...
    #red-ui-header-button-deploy {
        ...
        // Mobile touch-friendly deploy button
        @media screen and (max-width: 768px) {
        ...
        @media screen and (max-width: 480px) {
            padding: 10px 18px; // Even larger on phones
            min-height: 48px; // Extra comfortable tapping
        }
