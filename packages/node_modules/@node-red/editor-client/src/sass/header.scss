...
@media only screen and (max-width: 480px) {
    #red-ui-header {
        ...
        .red-ui-header-toolbar > li:not(.red-ui-deploy-button-group):not(.red-ui-mobile-toggle) {
            display: none;
        }
    }
...
@media only screen and (min-width: 481px) and (max-width: 768px) {
    // Show mobile toggles on tablet too
    #red-ui-header {
        .red-ui-mobile-palette-toggle,
        .red-ui-mobile-sidebar-toggle {
            display: inline-flex;
