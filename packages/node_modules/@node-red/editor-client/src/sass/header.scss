...
.red-ui-breadcrumb-container {
    background: var(--red-ui-workspace-header-background);
    ...
    .red-ui-breadcrumb-nav {
        padding: 0 12px;
        width: 100%;
    }
    
    .red-ui-breadcrumb-list {
        list-style: none;
        margin: 0;
        padding: 0;
        display: flex;
    ...
    .red-ui-breadcrumb-item {
        display: inline-flex;
        align-items: center;
    }
    
    .red-ui-breadcrumb-link {
        ...
        &:focus {
            outline: 2px solid var(--red-ui-form-button-background);
            outline-offset: 1px;
        }
    }
    
    .red-ui-breadcrumb-current {
        color: var(--red-ui-primary-text-color);
        padding: 4px 8px;
        font-weight: 500;
        min-height: 24px;
