...
#red-ui-header {
    ...
    backdrop-filter: var(--red-ui-header-backdrop-blur);
    ...
    box-shadow: var(--red-ui-shadow-medium);
    z-index: 1000;
    ...
    .red-ui-deploy-button {
        ...
        box-shadow: var(--red-ui-deploy-button-shadow);
        border-radius: 6px;
        font-weight: 600;
        letter-spacing: 0.5px;
        transition: all 0.2s cubic-bezier(0.4, 0, 0.2, 1);
        ...
        &:hover {
            ...
            box-shadow: var(--red-ui-deploy-button-shadow-hover);
