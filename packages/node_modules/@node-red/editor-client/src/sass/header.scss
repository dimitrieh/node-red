...
#red-ui-header {
    ...
    span.red-ui-header-logo {
        ...
        white-space: nowrap;
        font-weight: 700;
        background: linear-gradient(135deg, #FF6B6B 0%, #C02020 50%, #8B0000 100%);
    ...
    .red-ui-deploy-button {
        ...
        border: none;
        box-shadow: 0 4px 20px rgba(192, 32, 32, 0.3);
        font-weight: 600;
        ...
        &:hover {
            background: linear-gradient(135deg, #FF8E8E 0%, #D63030 50%, #A00000 100%);
            box-shadow: 0 6px 25px rgba(192, 32, 32, 0.4);
        ...
        &:focus {
            outline: none;
            box-shadow: 0 0 0 3px rgba(192, 32, 32, 0.4);
        }
        &:active {
            background: linear-gradient(135deg, #E05555 0%, #B01C1C 50%, #700000 100%);
            transform: translateY(0);
            box-shadow: 0 2px 15px rgba(192, 32, 32, 0.5);
        }
    }
