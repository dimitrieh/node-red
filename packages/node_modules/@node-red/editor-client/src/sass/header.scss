...
#red-ui-header {
    ...
    padding: 0px 24px 0px 24px; /* Enhanced padding for modern spacing */
    color: var(--red-ui-header-menu-color);
    font-size: 14px;
    display: flex;
    justify-content: space-between;
    align-items: center;
    border-bottom: 1px solid rgba(255, 255, 255, 0.1); /* Subtle modern border */
    padding-top: 0; /* Clean alignment */
    box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1); /* Modern depth */
