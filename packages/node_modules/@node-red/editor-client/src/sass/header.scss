...
@media only screen and (max-width: 768px) {
    #red-ui-header {
        ...
        height: 56px; /* Larger header for touch */
        
        .red-ui-header-toolbar {
            gap: 4px;
            
            /* Hide less critical buttons on small screens */
            > li:not(.red-ui-deploy-button-group) {
                @media (max-width: 480px) {
                    display: none;
                    
                    &.red-ui-header-button-menu {
                        display: inline-flex; /* Always show hamburger menu */
                    }
                }
            }
        }
