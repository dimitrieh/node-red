...
@media only screen and (max-width: 450px) {
    .red-ui-editor {
        ...
        // Optimize form rows for mobile
        .form-row {
            margin: 12px 0; // More spacing between form rows
        ...
        // Checkbox and radio button optimizations
        input[type="checkbox"],
        input[type="radio"] {
            transform: scale(1.3); // Larger checkboxes/radios for touch
            margin: 8px;
        }
