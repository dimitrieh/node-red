...
@media (max-width: 768px) {
    .red-ui-editor, .red-ui-editor-dialog {
        ...
        label {
            ...
            /* Ensure labels are touch-friendly when clickable */
            &[for] {
                cursor: pointer;
                display: flex;
                align-items: center;
        ...
        .form-horizontal {
            ...
            .form-actions {
                ...
                button {
                    ...
                    /* Side-by-side for primary actions */
        ...
        /* Form tips and help text */
        .form-tips, .help-block {
            font-size: 14px;
            line-height: 1.4;
            padding: 8px 12px;
            margin: 8px 0;
