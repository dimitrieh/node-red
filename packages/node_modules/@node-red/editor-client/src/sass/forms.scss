...
// Mobile form optimizations - Touch-friendly controls
@media only screen and (max-width: 1024px) {
    .red-ui-editor, .red-ui-editor-dialog {
        ...
        // Special cases for smaller controls
        input[type="checkbox"],
        input[type="radio"] {
            min-height: 20px;
            min-width: 20px;
        ...
        select {
            ...
            padding-right: 44px; // Space for dropdown arrow
        }
        ...
        .control-group.error {
            ...
            textarea {
                border-width: 2px;
                box-shadow: 0 0 0 2px rgba(var(--red-ui-form-input-border-error-color), 0.2);
            }
        }
        
        // Focus states - enhanced for touch
        input:focus,
        select:focus,
        textarea:focus,
        button:focus {
...
@media only screen and (min-width: 768px) and (max-width: 1024px) {
    .red-ui-editor, .red-ui-editor-dialog {
        // Slightly smaller than mobile, larger than desktop
        input,
        select,
        textarea,
        button {
