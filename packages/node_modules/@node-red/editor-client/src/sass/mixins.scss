...
// Modern shadow system for refined depth
@mixin component-shadow {
    box-shadow: 1px 1px 4px var(--red-ui-shadow);
}

@mixin modern-shadow-subtle {
    box-shadow: 0 1px 3px var(--red-ui-shadow-subtle);
}

@mixin modern-shadow-medium {
    box-shadow: 0 2px 8px var(--red-ui-shadow-medium);
}

@mixin modern-shadow-strong {
    box-shadow: 0 4px 16px var(--red-ui-shadow-strong);
}

// Modern transition system for smooth interactions
@mixin smooth-transition($properties: all, $duration: 0.2s) {
    transition: #{$properties} #{$duration} cubic-bezier(0.4, 0, 0.2, 1);
}

// Modern border radius for refined industrial feel
@mixin modern-border-radius($radius: 4px) {
    border-radius: $radius;
}

// Modern focus states for better accessibility
@mixin modern-focus-outline {
    &:focus {
        outline: 2px solid var(--red-ui-workspace-button-color-focus-outline);
        outline-offset: 2px;
    }
}
