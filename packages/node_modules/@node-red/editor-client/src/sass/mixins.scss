...
// === MOBILE & TABLET RESPONSIVE MIXINS ===

// Responsive breakpoints following modern mobile-first design
@mixin mobile-up {
...
@mixin mobile-smooth-transition {
    transition: all 0.2s cubic-bezier(0.4, 0, 0.2, 1);
}

@mixin mobile-tap-highlight {
    -webkit-tap-highlight-color: transparent;
    -webkit-touch-callout: none;
}

// Swipe gesture support
@mixin swipe-container {
    @include mobile-tap-highlight;
    touch-action: pan-x;
