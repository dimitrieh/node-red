...
@mixin workspace-button {
    ...
    // Modern 2025 button styling
    border-radius: var(--red-ui-border-radius-md);
    font-weight: 500;
    font-variation-settings: 'wght' 500; // Variable font weight
    letter-spacing: -0.005em;
    
    // Contemporary transition system
    transition: all 0.2s cubic-bezier(0.4, 0.0, 0.2, 1);
    
    // Subtle elevation and depth
    box-shadow: var(--red-ui-shadow-sm);
    
    // Modern hover effects
    &:hover {
        transform: translateY(-1px);
        box-shadow: var(--red-ui-shadow-md);
    }
