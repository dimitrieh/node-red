...
@media (max-width: 768px) {
    ...
    .red-ui-flow-node {
        stroke-width: 2; /* Thicker borders for visibility */
        cursor: grab;
        ...
        /* Enhanced node visibility on mobile */
    ...
    /* Enhanced node labels for mobile readability */
    .red-ui-flow-node-label {
    ...
    /* Touch-friendly link connections */
    .red-ui-flow-link-background {
        stroke-width: 32; /* Much larger touch area */
        fill: none;
        stroke: transparent;
        cursor: pointer;
    }
    ...
    .red-ui-flow-link-line {
        stroke-width: 3; /* Thicker visible connection lines */
        
        &.red-ui-flow-link-selected {
            stroke-width: 4;
            filter: drop-shadow(0 1px 4px rgba(0,0,0,0.3));
        }
    }
    
    /* Junction node enhancements for touch */
    .red-ui-flow-junction {
        .red-ui-flow-junction-background {
            transform: scale(1.5); /* Larger junction nodes */
            stroke-width: 2;
        }
        
        &:hover .red-ui-flow-junction-background {
            transform: scale(2); /* Even larger on hover */
        }
    ...
    .red-ui-flow-node-selected .red-ui-flow-node {
        stroke-width: 4;
        stroke-dasharray: none;
        filter: drop-shadow(0 4px 12px rgba(0,0,0,0.3));
    }
    
    /* Touch-optimized lasso selection */
    .nr-ui-view-lasso {
        stroke-width: 2;
        stroke-dasharray: 8 4;
    }
    
    /* Better visibility for node groups on mobile */
    .red-ui-flow-group-outline {
        stroke-width: 2;
        
        &.red-ui-flow-group-hovered .red-ui-flow-group-outline-select-line {
            stroke-width: 3;
...
/* Tablet-specific flow optimizations */
@media (min-width: 769px) and (max-width: 1024px) {
    /* Moderate enhancements for tablet */
    .red-ui-flow-node {
        stroke-width: 1.5;
    }
    
    .red-ui-flow-port {
        r: 6; /* Slightly larger ports */
    }
    ...
    .red-ui-flow-link-background {
        stroke-width: 24; /* Medium touch area */
    }
