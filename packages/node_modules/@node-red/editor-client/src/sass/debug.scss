...
/* Ensure debug panel doesn't include bottom panel tab buttons */
#red-ui-bottom-panel .red-ui-tab-link-buttons {
    display: none !important;
}

/* Ensure debug tab stays in sidebar */
#red-ui-tab-debug {
    /* Ensure debug tab styling when in sidebar */
    display: block;
}

/* Adjust sidebar positioning when debug panel is open */
.red-ui-sidebar {
