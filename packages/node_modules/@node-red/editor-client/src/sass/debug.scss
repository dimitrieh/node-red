...
.red-ui-debug-toolbar {
    ...
    .red-ui-debug-toolbar-left {
        ...
        .red-ui-debug-title-full {
            display: inline;
        }

        .red-ui-debug-title-short {
            display: none;
        }
    }

    .red-ui-debug-toolbar-right {
        display: flex;
        gap: 8px;
        align-items: center;
    }
...
// Undeployed message styles
.red-ui-debug-undeployed-message {
    background: var(--red-ui-notification-warning-background, #fff6e1);
    border: 1px solid var(--red-ui-notification-warning-border, #fcdd76);
    color: var(--red-ui-notification-warning-color, #AD5B00);
    padding: 10px;
    margin: 10px;
    border-radius: 4px;

    .red-ui-debug-undeployed-content {
        display: flex;
        align-items: center;
        gap: 10px;

        .red-ui-debug-undeployed-close {
            margin-left: auto;
