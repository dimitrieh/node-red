...
// Responsive breakpoints for mobile and tablet optimization
@media screen and (max-width: 768px) {
    .red-ui-editor {
        font-size: 16px; // Larger base font for mobile readability
        line-height: 1.6; // Better line height for touch screens
    }
}

@media screen and (max-width: 480px) {
    .red-ui-editor {
        font-size: 18px; // Even larger for small phones
    }
}
