...
.red-ui-editor {
    ...
    line-height: 1.6; /* Modern relative line-height for better readability */
    font-feature-settings: 'kern', 'liga', 'clig', 'calt'; /* Enhanced typography features */
...
.red-ui-icon-picker {
    ...
    p {
        margin: 0 0 16px; /* More generous spacing */
    ...
    li {
        ...
        margin-bottom: 4px; /* Better list spacing */
    }
    dl {
        margin-bottom: 20px;
    }
    ...
    hr {
        margin: 32px 0; /* More generous spacing */
        border: 0;
    ...
    blockquote {
        padding: 16px 0 16px 20px; /* Enhanced padding */
        margin: 0 0 24px; /* Better spacing */
        border-left: 4px solid var(--red-ui-secondary-border-color);
        color: var(--red-ui-secondary-text-color);
        background: rgba(255, 255, 255, 0.3); /* Subtle background */
        border-radius: 0 8px 8px 0; /* Modern rounded corner */
