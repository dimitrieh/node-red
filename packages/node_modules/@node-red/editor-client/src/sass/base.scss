...
// 2025 Modern Base - Global Enhancements
* {
...
.red-ui-palette-node, .red-ui-tabs > li,
.red-ui-sidebar-header, .red-ui-palette-header {
...
.red-ui-editor {
    ...
    line-height: 1.5; // Modern relative line height
    letter-spacing: -0.01em; // Subtle letter spacing for readability
    font-feature-settings: "liga" 1, "calt" 1; // Enable modern font features
