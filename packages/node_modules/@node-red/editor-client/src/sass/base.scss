...
.red-ui-editor {
    ...
    @media (max-width: 768px) {
        font-size: calc(var(--red-ui-primary-font-size) * 0.9);
    }
    
    @media (max-width: 480px) {
        font-size: calc(var(--red-ui-primary-font-size) * 0.85);
    }
    ...
    @media (prefers-color-scheme: dark) {
        ...
        --red-ui-primary-background-solid: #1a1d21;
    }
}
...
#red-ui-main-container {
    ...
    background: var(--red-ui-primary-background-solid);
}
...
.red-ui-icon-picker {
    ...
    pre {
        ...
        border-radius: 8px;
        box-shadow: var(--red-ui-shadow-soft);
