...
#red-ui-main-container {
    ...
    // Floating windows layout - workspace spans full width
    &.red-ui-palette-floating.red-ui-sidebar-floating {
        #red-ui-workspace {
            left: 0px;
            right: 0px;
        }
    }
    &.red-ui-palette-floating:not(.red-ui-sidebar-floating) {
        #red-ui-workspace {
            left: 0px;
        }
    }
    &.red-ui-sidebar-floating:not(.red-ui-palette-floating) {
        #red-ui-workspace {
            right: 0px;
        }
    }
