...
.red-ui-skip-links {
    ...
    .red-ui-skip-link {
        ...
        text-decoration: none;
        text-align: center;
        border: 2px solid var(--red-ui-focus-color, #0066cc);
        border-top: none;
...
:focus-visible {
    outline: var(--red-ui-focus-outline-width, 2px) solid var(--red-ui-focus-color, #0066cc);
    outline-offset: var(--red-ui-focus-outline-offset, 2px);
    border-radius: 2px;
}

/* Button focus indicators */
button:focus-visible,
.red-ui-button:focus-visible,
input[type="button"]:focus-visible,
input[type="submit"]:focus-visible {
    box-shadow: 0 0 0 var(--red-ui-focus-outline-width, 2px) var(--red-ui-focus-color, #0066cc);
    outline: none;
}
...
select:focus-visible {
    border-color: var(--red-ui-focus-color, #0066cc);
    box-shadow: 0 0 0 1px var(--red-ui-focus-color, #0066cc);
    outline: none;
}
...
@media (prefers-contrast: high) {
    :root {
        ...
        --red-ui-secondary-text-color: #000000;
        --red-ui-tertiary-text-color: #000000;
        --red-ui-focus-color: #0000ff;
        --red-ui-primary-border-color: #000000;
        --red-ui-secondary-border-color: #000000;
    }
}
...
.red-ui-keyboard-focus {
    background: var(--red-ui-secondary-background-selected);
    border: 1px solid var(--red-ui-focus-color, #0066cc);
}

/* High contrast border for separators and dividers */
[role="separator"] {
    border-color: var(--red-ui-primary-text-color);
}
...
input:disabled {
    ...
    background-color: var(--red-ui-secondary-background-disabled);
}
