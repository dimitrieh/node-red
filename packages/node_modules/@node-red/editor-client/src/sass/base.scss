...
body {
    overflow: hidden;
    // Modern font loading and rendering optimization
    font-display: swap;
...
.red-ui-editor {
    // Enhanced typography with modern scaling
    font-size: var(--red-ui-primary-font-size);
    font-family: var(--red-ui-primary-font);
    font-weight: 400;
    font-variation-settings: 'wght' 400; // Variable font support
    padding: 0;
    margin: 0;
    background: var(--red-ui-primary-background);
    color: var(--red-ui-primary-text-color);
    line-height: 1.5; // Modern line height for better readability
    letter-spacing: -0.01em; // Refined character spacing
