...
/* Disabled obsolete shade elements for floating mode */
.floating-mode #red-ui-palette-shade,
.floating-mode #red-ui-sidebar-shade {
    display: none;
}

#red-ui-editor-shade, #red-ui-header-shade {
    @include mixins.shade;
    z-index: 5;
}

/* Keep original shade rules for non-floating mode */
body:not(.floating-mode) #red-ui-palette-shade,
body:not(.floating-mode) #red-ui-sidebar-shade {
    @include mixins.shade;
    z-index: 5;
}
body:not(.floating-mode) #red-ui-sidebar-shade  {
