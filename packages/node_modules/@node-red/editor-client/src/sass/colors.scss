...
// Modern Industrial Typography System
$primary-font: -apple-system, BlinkMacSystemFont, 'Inter', 'SF Pro Display', 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif;
$primary-font-size: 14px;
$monospace-font: 'SF Mono', 'Monaco', 'Inconsolata', 'Fira Code', Menlo, Consolas, 'DejaVu Sans Mono', monospace;

// Modern Industrial Color Palette
$primary-background: #f8f9fa; // Softer, warmer light gray
$secondary-background: #ffffff; // Pure white for contrast
$secondary-background-selected: #e9ecef; // Refined selection state
$secondary-background-inactive: #f1f3f4; // Subtle inactive state  
$secondary-background-hover: #dee2e6; // Modern hover state
$secondary-background-disabled: #f8f9fa; // Consistent disabled state

$tertiary-background: #f5f6f7; // Sophisticated tertiary layer
...
// Modern Industrial Text Colors - Better contrast and readability
$primary-text-color: #343a40; // Improved contrast from #555
$secondary-text-color: #6c757d; // More refined gray
$secondary-text-color-focus: #495057; // Better focus visibility
$secondary-text-color-hover: #495057; // Consistent hover state
$secondary-text-color-active: #495057; // Clear active state
$secondary-text-color-selected: #495057; // Distinct selection
$secondary-text-color-inactive: #6c757d; // Subtle inactive
$secondary-text-color-disabled: #adb5bd; // Clearer disabled state
$secondary-text-color-disabled-active: #868e96; // Refined disabled active
$secondary-text-color-disabled-inactive: #ced4da; // Subtle disabled inactive

// Refined label and heading colors
$tertiary-text-color: #adb5bd; // Modern muted text
$header-text-color: #212529; // High contrast headers
...
// Modern Industrial Border System
$primary-border-color: #dee2e6; // Refined primary borders
$secondary-border-color: #e9ecef; // Subtle secondary borders  
$tertiary-border-color: #ced4da; // Lighter tertiary borders
...
$view-grid-color: #e9ecef; // Subtle but visible grid - maintains industrial feel
