...
$secondary-background-selected: #e8e8e8;
$secondary-background-inactive: #f8f8f8;
$secondary-background-hover: #f0f0f0;
$secondary-background-disabled: #fafafa;
...
$secondary-text-color-focus: #444444;
$secondary-text-color-hover: #444444;
$secondary-text-color-active: #444444;
$secondary-text-color-selected: #444444;
$secondary-text-color-inactive: #777777;
