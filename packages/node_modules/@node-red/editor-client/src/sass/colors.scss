...
$primary-font: 'SF Pro Display', -apple-system, BlinkMacSystemFont, 'Inter', 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;
$primary-font-size: 14px;
$monospace-font: 'SF Mono', 'Monaco', 'Menlo', 'Roboto Mono', 'Consolas', 'DejaVu Sans Mono', Courier, monospace;

$primary-background: #fafbfc;//#0ff;

$secondary-background: #ffffff;//#ff0;
$secondary-background-selected: #f0f2f5;//#e9e900;
$secondary-background-inactive: #f8f9fa;//#f0f000;
$secondary-background-hover: #f0f2f5;//#dd0;
$secondary-background-disabled: #fbfcfd;//#fafa0;

$tertiary-background:  #f8f9fa;//#f0f;

$shadow: 0 4px 12px rgba(0, 0, 0, 0.08), 0 2px 4px rgba(0, 0, 0, 0.04);
$shadow-soft: 0 2px 8px rgba(0, 0, 0, 0.06);
$shadow-medium: 0 6px 16px rgba(0, 0, 0, 0.1);
$shadow-bold: 0 12px 32px rgba(0, 0, 0, 0.12);

// Main body text
$primary-text-color: #1a1d23;//#0f0;
// UI control label text
$secondary-text-color: #6b7280;//#00f;
$secondary-text-color-focus: #374151;//#009;
$secondary-text-color-hover: #4b5563;//#006;
$secondary-text-color-active: #374151;//#006;
$secondary-text-color-selected: #1f2937;//#00A;
$secondary-text-color-inactive: #9ca3af;//#006;
$secondary-text-color-disabled: #d1d5db;//#00C;
$secondary-text-color-disabled-active: #9ca3af;//#009;
$secondary-text-color-disabled-inactive: #e5e7eb;//#00A;

// Sub label text
$tertiary-text-color: #9ca3af;//#90f;
// Heading text
$header-text-color: #111827;//#f00;
...
$primary-border-color: #d1d5db;//#f00;
$secondary-border-color: #e5e7eb;//#0f0;
$tertiary-border-color: #f3f4f6;//#00f;
...
$deploy-button-background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%);
$deploy-button-background-hover: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%);
$deploy-button-background-active: linear-gradient(135deg, #b91c1c 0%, #991b1b 100%);
