...
// Main body text - WCAG AA compliant (contrast ratio 4.6:1 on #f3f3f3)
$primary-text-color: #333333;
// UI control label text - WCAG AA compliant (contrast ratio 5.3:1 on #f3f3f3)
$secondary-text-color: #666666;
$secondary-text-color-focus: #666666;
$secondary-text-color-hover: #666666;
$secondary-text-color-active: #666666;
$secondary-text-color-selected: #666666;
$secondary-text-color-inactive: #666666;
$secondary-text-color-disabled: #bbb;
$secondary-text-color-disabled-active: #999;
$secondary-text-color-disabled-inactive: #aaa;

// Sub label text - Minimum WCAG AA compliant gray (contrast ratio 4.5:1)
$tertiary-text-color: #767676;
// Heading text - Enhanced contrast
$header-text-color: #333333;

// Accessibility-specific colors
$focus-color: #0066cc; // High contrast focus indicator
$focus-outline-width: 2px;
$focus-outline-offset: 2px;
$error-color: #d32f2f; // Accessible error red
$success-color: #2e7d32; // Accessible success green
$warning-color: #f57c00; // Accessible warning orange
