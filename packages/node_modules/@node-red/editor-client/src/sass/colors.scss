...
$monospace-font: 'SF Mono', Monaco, 'Inconsolata', 'Fira Code', 'Droid Sans Mono', Menlo, Consolas, 'DejaVu Sans Mono', Courier, monospace;

$primary-background: #f8f9fa;//#0ff;
...
$view-grid-color: rgba(108, 117, 125, 0.15);
