...
$secondary-background-selected: #f1f3f4;
$secondary-background-inactive: #f5f5f5;
$secondary-background-hover: #e8eaed;
$secondary-background-disabled: #fafbfc;

$tertiary-background: #f9fafb;
...
$secondary-text-color-focus: #3c4043;
$secondary-text-color-hover: #3c4043;
$secondary-text-color-active: #1a73e8;
$secondary-text-color-selected: #1a73e8;
$secondary-text-color-inactive: #9aa0a6;
$secondary-text-color-disabled: #bdc1c6;
$secondary-text-color-disabled-active: #9aa0a6;
$secondary-text-color-disabled-inactive: #bdc1c6;

// Sub label text
$tertiary-text-color: #9aa0a6;
// Heading text
...
$secondary-border-color: #e8eaed;
$tertiary-border-color: #f1f3f4;
