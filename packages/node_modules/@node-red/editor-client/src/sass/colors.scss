...
$primary-font: 'Inter', 'SF Pro Display', 'Segoe UI', system-ui, -apple-system, sans-serif;
$primary-font-size: 14px;
$secondary-font: 'JetBrains Mono', 'SF Mono', 'Monaco', 'Inconsolata', 'Roboto Mono', Consolas, 'DejaVu Sans Mono', monospace;
$monospace-font: $secondary-font;

$primary-background: linear-gradient(135deg, #fafafa 0%, #f0f2f5 100%);//Modern gradient background
$primary-background-solid: #f8f9fb;

$secondary-background: rgba(255, 255, 255, 0.95);//Modern semi-transparent
$secondary-background-selected: rgba(239, 246, 255, 0.8);//Subtle blue tint
$secondary-background-inactive: rgba(248, 249, 251, 0.9);//Softer inactive state
$secondary-background-hover: rgba(239, 246, 255, 0.6);//Interactive hover state
$secondary-background-disabled: rgba(249, 250, 252, 0.7);//Modern disabled state
...
$shadow-colored: rgba(194, 32, 32, 0.15);//Node-RED themed shadow
$shadow-glow: rgba(194, 32, 32, 0.3);//Accent glow effect
...
$header-background: linear-gradient(135deg, #1a1a1a 0%, #0f0f0f 50%, #000000 100%);//Modern dark gradient
$header-background-solid: #111111;//Fallback solid color
$header-button-background-active: #121212;
$header-accent: linear-gradient(135deg, #FF6B6B 0%, #C02020 50%, #8B0000 100%);//Modern gradient accent
$header-accent-solid: #C02020;//Original accent for compatibility
