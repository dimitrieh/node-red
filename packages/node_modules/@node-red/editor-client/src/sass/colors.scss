...
$primary-font: 'Inter', 'SF Pro Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;
$primary-font-size: 14px;
$monospace-font: 'SF Mono', 'Monaco', 'Cascadia Code', 'Roboto Mono', Consolas, 'Courier New', monospace;

// 2025 Modern Color System - Semantic Design Tokens
$primary-background: #fafafa; // Clean modern background
$primary-background-gradient: linear-gradient(180deg, #fafafa 0%, #f8f9fa 100%);

$secondary-background: #ffffff; // Pure white surfaces
$secondary-background-selected: #f0f4ff; // Modern blue-tinted selection
$secondary-background-inactive: #f8f9fa; // Subtle inactive state
$secondary-background-hover: #f5f5f7; // Sophisticated hover
$secondary-background-disabled: #fafbfc; // Accessible disabled state

$tertiary-background: #f8f9fa; // Subtle surface variation

// 2025 Modern Shadow System - Layered Depth
...
// 2025 Modern Text System - Enhanced Contrast & Accessibility
$primary-text-color: #1f2937; // Dark gray for excellent readability
// UI control label text with semantic states
$secondary-text-color: #6b7280; // Medium gray for secondary content
$secondary-text-color-focus: #374151; // Darker on focus for clarity
$secondary-text-color-hover: #4b5563; // Darker on hover
$secondary-text-color-active: #374151; // Active state emphasis
$secondary-text-color-selected: #1e40af; // Blue for selected items
$secondary-text-color-inactive: #9ca3af; // Light gray for inactive
$secondary-text-color-disabled: #d1d5db; // Accessible disabled color
$secondary-text-color-disabled-active: #9ca3af; // Disabled active state
$secondary-text-color-disabled-inactive: #e5e7eb; // Disabled inactive state

// 2025 Semantic Text Colors
$tertiary-text-color: #9ca3af; // Subtle text for labels/captions
$header-text-color: #111827; // Strong contrast for headings
...
// 2025 Modern Border System - Subtle & Clean
$primary-border-color: #e5e7eb; // Clean, modern border
$secondary-border-color: #f3f4f6; // Subtle dividers
$tertiary-border-color: #d1d5db; // Distinct separation
...
// 2025 Enhanced Workspace
$view-background: $secondary-background;
$view-grid-color: #f0f1f3; // Slightly more visible grid for industrial feel
