...
$primary-font: 'Inter', 'Segoe UI', 'Helvetica Neue', Arial, Helvetica, sans-serif;
$primary-font-size: 14px;
$monospace-font: 'JetBrains Mono', 'SF Mono', Menlo, Consolas, 'DejaVu Sans Mono', Courier, monospace;

// 2025 Modern Color System with enhanced contrast and depth
$primary-background: #f8fafc; // Softer, more refined background
$primary-background-glass: rgba(248, 250, 252, 0.85); // Glassmorphism variant

$secondary-background: #ffffff;
$secondary-background-glass: rgba(255, 255, 255, 0.7); // Glass effect for overlays
$secondary-background-selected: #f1f5f9; // More subtle selection
$secondary-background-inactive: #f8fafc;
$secondary-background-hover: #e2e8f0; // Enhanced hover with blue undertone
$secondary-background-disabled: #f1f5f9;

$tertiary-background: #f1f5f9; // Consistent with new palette

// Advanced Shadow System for 2025 depth
...
// Enhanced 2025 Text Colors with better contrast ratios
$primary-text-color: #1e293b; // Much stronger contrast for accessibility
// UI control label text
$secondary-text-color: #64748b; // Refined secondary text
...
// Heading text with enhanced contrast
$header-text-color: #0f172a; // Deep slate for headers
...
$accent-error: #ef4444; // Modern red
...
$primary-border-color: #cbd5e1; // Softer, more refined borders
$secondary-border-color: #e2e8f0; // Very subtle borders
$tertiary-border-color: #d1d5db; // Mid-tone borders
...
$view-grid-color: #f1f5f9; // Softer grid for industrial feel
...
$deploy-button-background: $accent-primary;
$deploy-button-background-hover: $accent-primary-hover;
$deploy-button-background-active: #1d4ed8; // Deeper blue for active state
$deploy-button-background-disabled: #444;
$deploy-button-background-disabled-hover: #555;


$header-background: #0f172a; // Deep modern slate instead of pure black
$header-background-glass: rgba(15, 23, 42, 0.9); // Glass variant for overlays
$header-button-background-active: #1e293b;
$header-accent: $accent-primary; // Use modern blue accent
