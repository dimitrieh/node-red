...
#red-ui-palette{
    ...
    // Modern industrial refinements
    @include mixins.smooth-transition(width, 0.2s);
    @include mixins.modern-shadow-subtle;
    border-right: 1px solid var(--red-ui-primary-border-color); // Refined border
...
.red-ui-palette-search {
    ...
    // Modern search area styling
    @include mixins.smooth-transition(background, 0.2s);
    
    &:focus-within {
        background: var(--red-ui-secondary-background);
        border-bottom-color: var(--red-ui-workspace-button-color-focus-outline);
    }
}
...
.red-ui-palette-header {
    ...
    text-align: left;
    padding: 9px;
    font-weight: 500; // Modern font weight - not too bold
    padding-left: 30px;
    overflow: hidden;
    user-select: none;
    
    // Modern industrial header styling
    @include mixins.smooth-transition(all, 0.2s);
    font-size: 13px; // Consistent sizing
    letter-spacing: 0.01em; // Subtle letter spacing
    
    &:hover {
        background: var(--red-ui-secondary-background-hover) !important;
        color: var(--red-ui-header-text-color); // Better contrast on hover
...
.red-ui-palette-node {
    ...
    margin: 10px auto;
    height: 25px;
    border-radius: 4px; // Slightly more refined radius
    border: 1px solid var(--red-ui-primary-border-color); // Use refined border color
    ...
    // Modern industrial node styling
    @include mixins.smooth-transition(all, 0.15s);
    @include mixins.modern-shadow-subtle;
...
.red-ui-palette-node:hover {
    ...
    // Modern hover enhancements
    transform: translateY(-1px) scale(1.02); // Subtle lift and scale
    @include mixins.modern-shadow-medium; // Enhanced shadow on hover
}
.red-ui-palette-port {
    position: absolute;
    top:8px;
