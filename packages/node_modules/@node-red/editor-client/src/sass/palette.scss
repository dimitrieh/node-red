...
@media only screen and (max-width: 767px) {
    #red-ui-palette {
        // Transform to mobile drawer/overlay
        position: fixed;
    ...
    // Mobile palette search - touch friendly
    .red-ui-palette-search {
        height: 48px;
        padding: 8px;
    ...
    // Touch-friendly node items
    .red-ui-palette-node {
        margin: 8px auto;
        height: 44px; // Touch-friendly height
        width: 140px; // Slightly wider for better touch
        border-radius: 8px;
    ...
    // Adjust ports for larger nodes
    .red-ui-palette-port {
        top: 17px; // Centered for 44px height
        width: 12px;
        height: 12px;
        border-radius: 6px;
    }
    ...
    .red-ui-palette-label {
        font-size: 14px;
        line-height: 44px; // Match node height
        margin: 0 40px; // Account for wider icon containers
    }
    
    // Scroll container adjustments
    .red-ui-palette-scroll {
        top: 48px; // Account for larger search
        padding: 8px 0;
...
// Tablet palette optimizations
@media only screen and (min-width: 768px) and (max-width: 1024px) {
    #red-ui-palette {
        width: 160px; // Narrower on tablet
    }
    ...
    .red-ui-palette-node {
        height: 32px; // Larger than desktop, smaller than mobile
        width: 130px;
        margin: 6px auto;
    }
    
    .red-ui-palette-port {
        top: 11px; // Centered for 32px height
    }
