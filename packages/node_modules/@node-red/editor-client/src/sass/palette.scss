...
@media only screen and (max-width: 450px) {
    #red-ui-palette {
        z-index: 999;
        width: 280px !important; // Slightly wider on mobile for easier use
        
        // Improve touch targets for mobile
        .red-ui-palette-category {
            .red-ui-palette-header {
                padding: 12px 8px;
                min-height: 44px; // Touch-friendly header
                font-size: 16px;
                font-weight: 500;
            }
            
            .red-ui-palette-node {
                margin: 6px 4px; // More spacing for touch
        ...
        .red-ui-searchBox-container {
            ...
            input {
                min-height: 44px; // Touch-friendly search
...
@media only screen and (min-width: 451px) and (max-width: 768px) {
    #red-ui-palette {
        width: 250px; // Narrower on tablet to save space
        
        .red-ui-palette-category {
            .red-ui-palette-node {
                margin: 4px 2px; // Tighter spacing for tablet
            }
        }
    }
}
