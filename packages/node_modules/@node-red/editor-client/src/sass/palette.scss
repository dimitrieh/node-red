...
#red-ui-palette{
    ...
    // @include mixins.component-border; // Remove border from palette
    transition: height 0.2s ease-in-out;
    resize: vertical; /* Enable resize */
    ...
    &:before {
        ...
        width: 100%;
        height: 7px;
        z-index: 10; /* Higher z-index for resize handle */
        position: absolute;
...
.red-ui-palette-resize-handle {
    ...
    z-index: 10;
    border-top: 2px solid var(--red-ui-primary-color); /* Add primary color top border */
...
// Add collapsible palette styles
