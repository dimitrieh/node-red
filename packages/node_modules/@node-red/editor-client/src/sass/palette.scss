...
.red-ui-palette-node {
    ...
    position: relative;
    z-index: 4;
    @include mixins.mobile-tap-highlight;
    transition: var(--red-ui-mobile-transition);
...
// === MOBILE & TABLET RESPONSIVE PALETTE ===

// Mobile-first palette optimizations
@media screen and (max-width: 768px) {
    #red-ui-palette {
        width: var(--red-ui-mobile-palette-width);
        position: fixed;
        top: var(--red-ui-mobile-header-height);
        left: 0;
        right: 0;
        height: 40vh;
        min-height: 300px;
        ...
        transition: transform var(--red-ui-mobile-transition);
        
        // Show palette when expanded
        &.mobile-expanded {
            transform: translateY(0);
        }
        
        // Hide resize grip on mobile
        &:before {
            display: none;
        }
    }
    
    // Mobile palette search
    .red-ui-palette-search {
        height: var(--red-ui-touch-target-min);
        padding: var(--red-ui-mobile-spacing-sm);
    ...
    // Touch-friendly palette headers
    .red-ui-palette-header {
        @include mixins.touch-target;
        @include mixins.mobile-tap-highlight;
        padding: var(--red-ui-mobile-spacing-md) var(--red-ui-mobile-spacing-lg);
        font-size: 16px;
        border-radius: 8px;
        margin: var(--red-ui-mobile-spacing-xs);
        
        &:active {
            transform: scale(0.98);
            background: var(--red-ui-palette-header-background-hover) !important;
        }
    }
    
    // Enhanced mobile node items
    .red-ui-palette-node {
        height: var(--red-ui-mobile-palette-item-height);
        width: calc(100% - var(--red-ui-mobile-spacing-lg));
        margin: var(--red-ui-mobile-spacing-sm) auto;
        border-radius: 12px;
        @include mixins.touch-target;
        display: flex;
        align-items: center;
    ...
    .red-ui-palette-label {
        font-size: 14px;
        font-weight: 500;
        margin: 0 0 0 var(--red-ui-mobile-spacing-md);
        text-align: left;
    }
    
    // Mobile palette content
    .red-ui-palette-content {
        padding: var(--red-ui-mobile-spacing-sm) var(--red-ui-mobile-spacing-md);
        display: grid;
        gap: var(--red-ui-mobile-spacing-xs);
    }
}

// Mobile phone specific (<480px)
@media screen and (max-width: 480px) {
    ...
    .red-ui-palette-node {
        height: var(--red-ui-touch-target-large);
        font-size: 16px;
    }
}
...
@media screen and (min-width: 768px) and (max-width: 1024px) {
    #red-ui-palette {
        width: var(--red-ui-tablet-palette-width);
        position: absolute;
        top: 0;
        transform: none;
        height: 100%;
    ...
    .red-ui-palette-node {
        @include mixins.touch-target;
        width: calc(100% - var(--red-ui-touch-padding));
        margin: var(--red-ui-mobile-spacing-xs) auto;
    }
    
    .red-ui-palette-header {
        @include mixins.touch-target;
        font-size: 15px;
        padding: var(--red-ui-touch-padding);
    }
}
...
@media (hover: hover) and (min-width: 1024px) {
    ...
    .red-ui-palette-header:hover {
        transform: none; // Prevent movement for category headers
    }
}
