...
#red-ui-palette{
    // When used as floating window content, remove fixed positioning
    &.red-ui-floating-palette-content {
        position: relative;
        top: auto;
        bottom: auto;
        left: auto;
    ...
    // Original fixed positioning (kept for potential fallback)
    position: absolute;
    top: 0px;
    bottom: 0px;
    left:0px;
    ...
    // Hide grip handle in floating mode
    &.red-ui-floating-palette-content:before {
        display: none;
    }
}
