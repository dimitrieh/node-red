...
#red-ui-palette{
    ...
    // Add floating window title bar
    .red-ui-palette-title-bar {
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
    ...
    .red-ui-palette-title-bar .red-ui-palette-title {
        flex: 1;
        font-size: 12px;
    }
    
    .red-ui-palette-title-bar .red-ui-palette-controls {
        display: flex;
        gap: 5px;
    }
    
    .red-ui-palette-title-bar .red-ui-palette-control-btn {
        width: 16px;
        height: 16px;
        border: none;
        border-radius: 2px;
    ...
    &:before {
        ...
        display: none; // Hide the original grip
    }
}
...
.red-ui-palette-scroll {
    position: absolute;
    top: 65px; // Account for title bar (30px) + search (35px)
    right: 0;
    bottom: 25px;
    left:0;
    padding: 0;
