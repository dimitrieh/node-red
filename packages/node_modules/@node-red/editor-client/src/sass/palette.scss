...
#red-ui-palette{
    ...
    transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); // Modern smooth transition
    
    // 2025 Revolutionary Palette Design - Glassmorphism with depth
    backdrop-filter: blur(16px);
    border: 1px solid rgba(255, 255, 255, 0.3);
    box-shadow: var(--red-ui-shadow-xl);
    border-radius: 0 16px 16px 0; // Round right side
    
    // Advanced hover animations
    &:hover {
        transform: translateX(2px);
        box-shadow: var(--red-ui-shadow-2xl);
