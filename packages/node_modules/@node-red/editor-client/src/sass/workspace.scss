...
#red-ui-workspace-chart {
   overflow: auto;
   position: absolute;
   bottom:0px; // Changed from 26px to 0px - footer now floats on top
   top: 35px;
   left:0px;
   right:0px;
...
// Custom workspace footer styles - floats on top of canvas
...
button.red-ui-footer-button {
    ...
    // Make footer buttons same size as tab link buttons
    #red-ui-workspace-footer & {
        width: 28px;
        height: 28px;
        line-height: 26px;
