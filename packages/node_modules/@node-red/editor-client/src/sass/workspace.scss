...
#red-ui-workspace-chart {
   ...
   @media only screen and (max-width: 768px) {
       // Ensure workspace is fully accessible on mobile
       top: 40px; // Account for larger mobile header
       bottom: 30px; // Account for larger footer
       ...
       .red-ui-flow-node {
           ...
           // Larger touch targets for node ports
           .red-ui-flow-port {
               min-width: 12px;
               min-height: 12px;
           }
       ...
       // Enhanced grid visibility on touch devices
