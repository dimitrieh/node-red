...
#red-ui-workspace {
    ...
    // Mobile layout: full width workspace when sidebar/palette are closed
    @include mixins.mobile-only {
        left: 0;
        right: 0;
        
        // Show mobile navigation overlay when palette/sidebar are opened
        &.red-ui-mobile-palette-open {
            left: 0;
            right: 0;
        }
    }
    ...
    @include mixins.tablet-only {
        left: 160px; // Slightly narrower palette
        right: 280px; // Narrower sidebar
