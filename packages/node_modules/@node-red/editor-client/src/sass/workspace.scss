...
#red-ui-workspace {
    ...
    // 2025 Modern Glassmorphism Effect
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 100%);
    backdrop-filter: blur(10px);
    border: 1px solid rgba(255, 255, 255, 0.2);
    box-shadow: var(--red-ui-shadow-lg);
    border-radius: 12px;
    
    // Advanced hover effects
    &:hover {
        box-shadow: var(--red-ui-shadow-xl);
...
#red-ui-workspace-chart {
   ...
   transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); // Modern smooth transitions
   
   // 2025 Modern Chart Background
   background: linear-gradient(135deg, #fefefe 0%, #f8fafc 100%);
   border-radius: 8px;
   
   &:focus {
       outline: 2px solid rgba(59, 130, 246, 0.5); // Modern focus ring
       outline-offset: 2px;
   }
