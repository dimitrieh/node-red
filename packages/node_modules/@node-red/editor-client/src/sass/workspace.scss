...
#red-ui-workspace-chart {
   overflow: auto;
   position: absolute;
   bottom:0px;  // Changed from 26px to use full height
   top: 35px;
   left:0px;
   right:0px;
...
// Override workspace footer specific styles to float on canvas
#red-ui-workspace-footer.red-ui-workspace-footer {
...
// Match tab-link-button size for workspace footer buttons
#red-ui-workspace-footer.red-ui-workspace-footer {
    a.red-ui-footer-button,
    button.red-ui-footer-button {
...
// Match tab-link-button size for workspace footer toggle buttons
#red-ui-workspace-footer.red-ui-workspace-footer {
    a.red-ui-footer-button-toggle,
    button.red-ui-footer-button-toggle {
        width: 28px !important;
