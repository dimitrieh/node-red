...
#red-ui-workspace {
    ...
    @include mixins.smooth-transition; // Enhanced transitions
...
#red-ui-workspace-chart {
   ...
   border-radius: 12px; // Rounded corners for inner chart
   
   &:focus {
       outline: none;
       // Add subtle glow on focus
       box-shadow: inset 0 0 0 2px rgba(94, 129, 255, 0.3);
   }
   
   // Ensure grid pattern is preserved but with modern feel
   .red-ui-workspace-chart-background {
       // The grid will be handled by the view-grid-color variable
       // which we set to a very subtle white for modern dark theme
   }
}
