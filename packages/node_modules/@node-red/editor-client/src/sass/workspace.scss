...
@media only screen and (max-width: 767px) {
    ...
    #red-ui-workspace-chart {
        ...
        // Prevent zooming/panning conflicts with page zoom
        touch-action: pan-x pan-y;
    }
    
    // Mobile workspace tabs - touch friendly
    .red-ui-tabs {
        ...
        li {
            ...
            // Tab close button - larger for touch
            .red-ui-tab-close {
                width: 32px;
                height: 32px;
                right: 8px;
        ...
        // Tab scroll buttons - touch friendly
    ...
    .red-ui-statusbar {
        height: 32px; // Taller for better touch
    ...
    #red-ui-loading-progress > div {
        width: 280px; // Narrower for mobile
...
@media only screen and (max-width: 767px) and (orientation: landscape) {
    #red-ui-workspace {
        top: 48px; // Smaller header in landscape
    }
    
    #red-ui-workspace-chart {
        top: 40px; // Smaller tabs in landscape
    }
