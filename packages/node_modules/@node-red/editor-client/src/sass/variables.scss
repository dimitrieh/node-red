...
:root {
    ...
    // Modern spacing scale (8px base grid)
    --red-ui-spacing-xs: 4px;
    --red-ui-spacing-sm: 8px;
    --red-ui-spacing-md: 16px;
    --red-ui-spacing-lg: 24px;
    --red-ui-spacing-xl: 32px;
    --red-ui-spacing-2xl: 48px;
    --red-ui-spacing-3xl: 64px;
    
    // Contemporary border radius system
    --red-ui-border-radius-sm: 4px;
    --red-ui-border-radius-md: 8px;
    --red-ui-border-radius-lg: 12px;
    --red-ui-border-radius-xl: 16px;
    --red-ui-border-radius-2xl: 24px;
    --red-ui-border-radius-full: 9999px;
    
    // Modern shadow system
    --red-ui-shadow-sm: #{colors.$shadow-sm};
    --red-ui-shadow-md: #{colors.$shadow-md};
    --red-ui-shadow-lg: #{colors.$shadow-lg};
    --red-ui-shadow-xl: #{colors.$shadow-xl};
    
    // Enhanced elevation background for glass morphism
    --red-ui-primary-background-elevated: #{colors.$primary-background-elevated};
