...
:root {
    ...
    --red-ui-primary-background-dark: #{colors.$primary-background-dark};
    ...
    --red-ui-shadow-subtle: #{colors.$shadow-subtle};
    --red-ui-shadow-soft: #{colors.$shadow-soft};
    --red-ui-shadow-medium: #{colors.$shadow-medium};
    --red-ui-shadow-strong: #{colors.$shadow-strong};
    --red-ui-shadow-intense: #{colors.$shadow-intense};
...
// Heading text
    ...
    --red-ui-form-input-focus-border-color: #{colors.$form-input-focus-border-color};
