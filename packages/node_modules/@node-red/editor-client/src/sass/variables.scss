...
:root {
    ...
    // === MOBILE & TABLET RESPONSIVE VARIABLES ===
    
    // Touch-friendly sizing
    --red-ui-touch-target-min: 44px;
    --red-ui-touch-target-large: 56px;
    --red-ui-touch-padding: 12px;
    --red-ui-touch-padding-large: 16px;
    
    // Mobile-specific spacing
    --red-ui-mobile-spacing-xs: 4px;
    --red-ui-mobile-spacing-sm: 8px;
    --red-ui-mobile-spacing-md: 16px;
    --red-ui-mobile-spacing-lg: 24px;
    --red-ui-mobile-spacing-xl: 32px;
    
    // Mobile header adjustments
    --red-ui-mobile-header-height: 60px;
    --red-ui-tablet-header-height: 56px;
    
    // Mobile palette sizing
    --red-ui-mobile-palette-width: 100%;
    --red-ui-tablet-palette-width: 280px;
    --red-ui-mobile-palette-item-height: 52px;
    
    // Mobile sidebar sizing  
    --red-ui-mobile-sidebar-width: 100%;
    --red-ui-tablet-sidebar-width: 320px;
    
    // Touch animations
    --red-ui-mobile-transition: 0.2s cubic-bezier(0.4, 0, 0.2, 1);
    --red-ui-mobile-transition-fast: 0.15s cubic-bezier(0.4, 0, 0.2, 1);
