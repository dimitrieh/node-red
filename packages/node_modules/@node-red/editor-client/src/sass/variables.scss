...
:root {
    ...
    --red-ui-primary-background-solid: #{colors.$primary-background-solid};
    ...
    --red-ui-shadow-soft: #{colors.$shadow-soft};
    --red-ui-shadow-medium: #{colors.$shadow-medium};
    --red-ui-shadow-large: #{colors.$shadow-large};
    --red-ui-shadow-elevated: #{colors.$shadow-elevated};
...
// Heading text
    ...
    --red-ui-workspace-button-shadow: #{colors.$workspace-button-shadow};
    --red-ui-workspace-button-shadow-hover: #{colors.$workspace-button-shadow-hover};
    ...
    --red-ui-deploy-button-shadow: #{colors.$deploy-button-shadow};
    --red-ui-deploy-button-shadow-hover: #{colors.$deploy-button-shadow-hover};


    --red-ui-header-background: #{colors.$header-background};
    --red-ui-header-backdrop-blur: #{colors.$header-backdrop-blur};
