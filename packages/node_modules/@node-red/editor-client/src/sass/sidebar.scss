...
.red-ui-sidebar-header {
    ...
    text-align: right;
    padding: 12px 16px;
    background: linear-gradient(135deg, rgba(240, 242, 245, 0.9) 0%, rgba(248, 249, 251, 0.95) 100%);
    backdrop-filter: blur(10px);
    -webkit-backdrop-filter: blur(10px);
    ...
    &:hover {
        background: linear-gradient(135deg, rgba(255, 107, 107, 0.1) 0%, rgba(192, 32, 32, 0.05) 100%);
