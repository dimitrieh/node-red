...
@media only screen and (max-width: 450px) {
    #red-ui-sidebar {
        z-index: 999;
        width: 320px !important; // Optimal mobile width
        ...
        // Improve sidebar content readability
        .red-ui-sidebar-content {
            padding: 12px;
            ...
            * {
            ...
            // Touch-friendly buttons in sidebar
        ...
        .red-ui-info-table {
            tr {
                td {
                    padding: 8px 4px; // More padding for readability
                    font-size: 14px;
                }
            }
        }
...
@media only screen and (min-width: 451px) and (max-width: 768px) {
    #red-ui-sidebar {
        width: 280px !important; // Tablet width optimization
