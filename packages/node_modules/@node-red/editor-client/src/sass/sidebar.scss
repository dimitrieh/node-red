...
// New styles for split sidebar layout
...
#red-ui-sidebar-content-upper {
    background: var(--red-ui-secondary-background);
    overflow: hidden;
}

#red-ui-sidebar-content-lower {
    background: var(--red-ui-secondary-background);
}

#red-ui-sidebar-horizontal-splitter {
