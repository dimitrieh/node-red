...
// When bottom panel is open, adjust sidebar height to avoid overlap
:not(.red-ui-bottom-panel-closed) #red-ui-sidebar {
    bottom: 200px; // Default bottom panel height
}
:not(.red-ui-bottom-panel-closed) #red-ui-sidebar-separator {
    bottom: 210px; // 200px (panel height) + 10px (margin)
}
