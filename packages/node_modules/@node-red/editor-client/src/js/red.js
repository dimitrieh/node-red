    ...
    function buildEditor(options) {
        ...
        $('<div id="red-ui-main-container" class="red-ui-sidebar-closed hide">'+
            ...
            '<div id="red-ui-palette">'+
                '<div class="red-ui-palette-title-bar">'+
                    '<span class="title">Node Palette</span>'+
                    '<div class="controls">'+
                        '<div class="control-button" id="red-ui-palette-minimize" title="Minimize">−</div>'+
                        '<div class="control-button" id="red-ui-palette-close" title="Close">×</div>'+
                    '</div>'+
                '</div>'+
                '<div class="red-ui-palette-content-wrapper"></div>'+
            '</div>'+
            '<div id="red-ui-sidebar">'+
                '<div class="red-ui-sidebar-title-bar">'+
                    '<span class="title">Information</span>'+
                    '<div class="controls">'+
                        '<div class="control-button" id="red-ui-sidebar-minimize" title="Minimize">−</div>'+
                        '<div class="control-button" id="red-ui-sidebar-close" title="Close">×</div>'+
                    '</div>'+
                '</div>'+
            '</div>'+
