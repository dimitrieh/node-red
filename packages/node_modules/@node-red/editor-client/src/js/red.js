...
var RED = (function() {
    ...
    function loadEditor() {
        ...
        // Create floating palette container and initialize palette
        var paletteContainer = $('<div id="red-ui-palette"></div>');
        RED.palette.init(paletteContainer);
        
        // Create floating palette window
        RED.floatingWindow.create({
            id: 'palette',
            title: 'Palette',
            width: 200,
            height: 500,
            ...
            className: 'red-ui-floating-window-palette'
        });
        ...
        // Create floating sidebar container and initialize sidebar
        var sidebarContainer = $('<div id="red-ui-sidebar"></div>');
        RED.sidebar.init(sidebarContainer);
        ...
        RED.floatingWindow.create({
            ...
            className: 'red-ui-floating-window-sidebar'
        });
