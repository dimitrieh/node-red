...
var RED = (function() {
    ...
    function loadEditor() {
        ...
        if (RED.settings.theme("multiplayer.enabled",false) || RED.settings.collaborativeEditing) {
            RED.multiplayer.init()
        }
        RED.comms.connect();

        // Initialize collaborative editing if enabled
        if (RED.settings.collaborativeEditing) {
            RED.automerge.init();
        }
        ...
        $.getJSON(options.apiRootUrl+"theme", function(theme) {
            if (theme.header) {
                ...
                if (theme.header.title) {
                    ...
                    if (theme.header.dashboardUrl) {
                        headerContainer.append(' | ')
                            .append($('<a>', {
                                href: theme.header.dashboardUrl,
                                target: '_blank',
                                text: 'Dashboard',
                                style: 'color: inherit; text-decoration: underline;'
                            }));
