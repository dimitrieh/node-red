...
var RED = (function() {
    ...
    function buildEditor(options) {
        // Correct layout order: header → footer → palette → main-container
        ...
        $('<div id="red-ui-component-footer" class="red-ui-component-footer"></div>').appendTo(options.target);
        $('<div id="red-ui-palette"></div>').appendTo(options.target);
