...
var RED = (function() {
    ...
    function loadEditor() {
        ...
        // Convert palette and sidebar to floating windows
        setTimeout(function() {
            if (typeof RED.floatingWindow !== 'undefined') {
                // Make palette floating
                RED.palette.floatingWindow = RED.floatingWindow.create('#red-ui-palette', {
                    title: 'Node Palette',
                    defaultWidth: 200,
                    defaultHeight: 400,
                    minWidth: 150,
                ...
                RED.sidebar.floatingWindow = RED.floatingWindow.create('#red-ui-sidebar', {
                    title: 'Sidebar',
                    defaultWidth: 320,
                    defaultHeight: 500,
                    minWidth: 250,
                ...
                // Update workspace to use full space
                $('#red-ui-workspace').css({
                    left: '0px',
                    right: '0px'
                });
                
                // Hide separators since they're no longer needed
                $('#red-ui-sidebar-separator').hide();
                
                // Remove palette closed classes since it's now floating
                $('#red-ui-main-container').removeClass('red-ui-palette-closed red-ui-sidebar-closed');
                
                // Add floating mode class to enable full workspace
