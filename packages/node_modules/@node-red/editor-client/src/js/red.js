...
var RED = (function() {
    ...
    function buildMainMenu() {
        ...
        menuOptions.push({id:"menu-item-view-menu",label:RED._("menu.label.view.view"),options:[
            ...
            {id:"menu-item-bottom-panel",label:RED._("menu.label.bottomPanel.show"),toggle:true,onselect:"core:toggle-bottom-panel", selected: false},
    ...
    function buildEditor(options) {
        ...
        $('<div id="red-ui-main-container" class="red-ui-sidebar-closed red-ui-bottom-panel-closed hide">'+
            '<div id="red-ui-workspace"></div>'+
            '<div id="red-ui-editor-stack" tabindex="-1"></div>'+
            '<div id="red-ui-palette"></div>'+
            '<div id="red-ui-sidebar"></div>'+
            '<div id="red-ui-sidebar-separator"></div>'+
            '<div id="red-ui-bottom-panel"></div>'+
            '<div id="red-ui-bottom-panel-separator"></div>'+
