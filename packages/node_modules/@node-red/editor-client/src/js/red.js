...
var RED = (function() {
    ...
    function buildEditor(options) {
        var header = $('<header id="red-ui-header" role="banner" aria-label="Node-RED Editor Header"></header>').appendTo(options.target);
        var logo = $('<div class="red-ui-header-logo" role="img" aria-label="Node-RED Logo"></div>').appendTo(header);
        $('<ul class="red-ui-header-toolbar hide" role="toolbar" aria-label="Main Toolbar"></ul>').appendTo(header);
        $('<div id="red-ui-header-shade" class="hide" aria-hidden="true"></div>').appendTo(header);
        $('<main id="red-ui-main-container" class="red-ui-sidebar-closed hide" role="main" aria-label="Flow Editor Workspace">'+
            '<section id="red-ui-workspace" role="region" aria-label="Flow Canvas" tabindex="0"></section>'+
            '<div id="red-ui-editor-stack" tabindex="-1" aria-hidden="true"></div>'+
            '<aside id="red-ui-palette" role="complementary" aria-label="Node Palette" tabindex="0"></aside>'+
            '<aside id="red-ui-sidebar" role="complementary" aria-label="Information Sidebar" tabindex="0"></aside>'+
            '<div id="red-ui-sidebar-separator" role="separator" aria-orientation="vertical" aria-label="Sidebar Resize Handle" tabindex="0"></div>'+
        '</main>').appendTo(options.target);
        $('<div id="red-ui-editor-plugin-configs" aria-hidden="true"></div>').appendTo(options.target);
        $('<div id="red-ui-editor-node-configs" aria-hidden="true"></div>').appendTo(options.target);
        $('<div id="red-ui-full-shade" class="hide" aria-hidden="true"></div>').appendTo(options.target);
