...
RED.sidebar.info = (function() {
    ...
    function resizeStack() {
        if (panels) {
            // Get the actual available height of the sidebar content area
            var sidebarContent = $("#red-ui-sidebar-content");
            var availableHeight = sidebarContent.height();
            
            // Calculate height for info stack, accounting for tip container
            var tipHeight = tipContainer.outerHeight() || 0;
            var h = Math.max(100, availableHeight - tipHeight);
