...
RED.sidebar.info = (function() {
    ...
    var content;
    // var panels; - removed as outliner moved to left sidebar
    var infoSection;
    ...
    function resizeStack() {
        // No longer need to resize panels since outliner moved to left sidebar
    }
    function init() {
        ...
        // Remove the stack container since we no longer need the outliner here
        var propertiesPanel = $("<div>",{class:"red-ui-sidebar-info-properties"}).css({
            "overflow":"hidden",
            "height":"100%",
            "display": "flex",
        ...
        propertiesPanelHeaderReveal = $('<button type="button" class="red-ui-button red-ui-button-small"><i class="fa fa-search"></button>').css({
            ...
            evt.stopPropagation();
            if (selectedObject) {
                // Switch to outline tab in left sidebar and reveal
                if (RED.leftSidebar) {
                    RED.leftSidebar.showOutliner();
                }
        ...
        // Outliner is now in the left sidebar, no need for panels here
