...
RED.sidebar.info = (function() {
    ...
    function init() {
        ...
        // Removed outliner panel - only properties panel now
        ...
        propertiesPanelHeaderReveal = $('<button type="button" class="red-ui-button red-ui-button-small"><i class="fa fa-search"></button>').css({
            ...
            evt.stopPropagation();
            if (selectedObject) {
                // Just reveal in view, no outliner anymore
        ...
        // Removed panels and outliner.build() - no longer needed
