 ...
 RED.tray = (function() {
    ...
    function showTray(options) {
        ...
        if (!options.maximized) {
            el.draggable({
                ...
                drag: function(event,ui) {
                    // Allow resizing but keep minimum constraints
                    if (ui.position.left > 0) {
                        ui.position.left = 0;
                    } else if (ui.position.left < -tray.preferredWidth*2) {
                        // Allow up to 2x the preferred width
                        ui.position.left = -tray.preferredWidth*2;
                    }
        ...
        function finishBuild() {
            ...
            if (options.width) {
                ...
                // Always use the preferred width (500px)
    ...
    function handleWindowResize() {
        if (stack.length > 0) {
            ...
            // Don't constrain width - keep it at preferredWidth (500px)
            if (!tray.width || tray.width < tray.preferredWidth) {
