...
RED.deploy = (function() {
    ...
    function init(options) {
        ...
        if (type == "default") {
            ...
            $('<li><a id="red-ui-header-button-theme-toggle" class="red-ui-header-button" href="#" title="Toggle Dark Mode">'+
    ...
    function toggleTheme() {
        ...
        localStorage.setItem('nodeRedTheme', newTheme);
        
        // Update toggle button icon
        const toggleIcon = $('#red-ui-header-button-theme-toggle i');
        toggleIcon.removeClass('fa-moon-o fa-sun-o');
        toggleIcon.addClass(newTheme === 'dark' ? 'fa-sun-o' : 'fa-moon-o');
    }

    function initTheme() {
        // Initialize theme from localStorage or default to light
        const savedTheme = localStorage.getItem('nodeRedTheme') || 'light';
        document.body.setAttribute('data-theme', savedTheme);
        
        // Set correct icon
        const toggleIcon = $('#red-ui-header-button-theme-toggle i');
        toggleIcon.removeClass('fa-moon-o fa-sun-o');
        toggleIcon.addClass(savedTheme === 'dark' ? 'fa-sun-o' : 'fa-moon-o');
    }
