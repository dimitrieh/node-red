...
RED.palette = (function() {
    ...
    function init() {
        // Create floating palette container
        var paletteContent = $('<div id="red-ui-palette"></div>');
        ...
        var paletteWindow = RED.floatingWindow.create({
            id: 'palette',
            title: 'Node Palette',
        ...
        RED.windowManager.register('palette', paletteWindow, {
            defaultWidth: '180px',
            defaultHeight: '400px',
            shortcut: {
                action: 'core:toggle-palette-window'
            }
        });
