...
RED.palette = (function() {
    ...
    function initFloatingWindow() {
        ...
        floatingWindowId = RED.floatingWindows.create({
            ...
            draggable: true,
            minimizable: true,
            closable: false, // Don't allow closing the palette
            content: '', // Will be populated after creation
            onResize: function(width, height) {
                // Handle resize if needed
                $("#red-ui-palette").trigger('resize');
            }
        });

        // Move the existing palette content into the floating window
    ...
    return {
        ...
        toggleFloating: toggleFloatingPalette,
        add:addNodeType,
