...
RED.palette = (function() {
    ...
    function init() {
        ...
        // Set the window type for styling
        paletteWindow.element.attr('data-window-type', 'palette');

        // Move the existing palette content to the floating window
        var paletteContent = $("#red-ui-palette");
        paletteContent.appendTo(paletteWindow.content);
    ...
    function togglePalette(state) {
        // Toggle floating window visibility instead of sidebar
        RED.floatingWindows.toggle('palette-window');
