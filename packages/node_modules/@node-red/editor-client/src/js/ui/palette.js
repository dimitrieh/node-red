...
RED.palette = (function() {
    ...
    function init() {
        ...
        // Initialize floating window for palette
        setTimeout(function() {
            initFloatingWindow();
        }, 100);
        
        // Add action for floating palette toggle
        RED.actions.add("core:toggle-floating-palette", function() {
    ...
    function initFloatingWindow() {
        ...
        var paletteElement = $("#red-ui-palette");
        
        // Add floating class to enable floating styles
        paletteElement.addClass('red-ui-palette-floating');
        
        // Create floating window
        var floatingWindow = RED.floatingWindows.createWindow({
            id: 'red-ui-palette',
            title: 'Node Palette',
            content: paletteElement,
            width: 200,
            height: 400,
            x: 50,
            y: 50
        ...
        paletteElement.data('floating-window', floatingWindow);
        
        // Update workspace positioning
        updateWorkspaceForFloatingPalette(true);
    }
    
    function updateWorkspaceForFloatingPalette(isFloating) {
        if (isFloating) {
            // Remove palette width from workspace calculation
            $('#red-ui-workspace').css('left', '0px');
            $('#red-ui-editor-stack').css('left', '0px');
        } else {
            // Restore original positioning
            $('#red-ui-workspace').css('left', '180px');
            $('#red-ui-editor-stack').css('left', '180px');
        }
    }
    
    function toggleFloatingPalette() {
        var floatingWindow = $("#red-ui-palette").data('floating-window');
        if (floatingWindow && floatingWindow.is(':visible')) {
            RED.floatingWindows.closeWindow('red-ui-palette');
        } else {
            RED.floatingWindows.showWindow('red-ui-palette');
        }
    }
    ...
    return {
        ...
        toggleFloatingPalette: toggleFloatingPalette
    };
})();
