...
RED.palette = (function() {
    ...
    var floatingPaletteWindow = null;

    function init() {
        // Enable floating mode on body
        $('body').addClass('red-ui-floating-mode');
        
        // Create the palette content for the floating window
        var paletteContent = $('<div id="red-ui-palette" class="red-ui-floating-palette-content">');
        
        $('<img src="red/images/spin.svg" class="red-ui-palette-spinner hide"/>').appendTo(paletteContent);
        $('<div id="red-ui-palette-search" class="red-ui-palette-search hide"><input type="text" data-i18n="[placeholder]palette.filter"></input></div>').appendTo(paletteContent);
        $('<div id="red-ui-palette-container" class="red-ui-palette-scroll hide"></div>').appendTo(paletteContent);
        $('<div class="red-ui-component-footer"></div>').appendTo(paletteContent);
        $('<div id="red-ui-palette-shade" class="hide"></div>').appendTo(paletteContent);
        
        // Create the floating window
        floatingPaletteWindow = RED.floatingWindows.createFloatingWindow(
            paletteContent,
            'Node Palette',
            {
                left: 20,
        ...
        floatingPaletteWindow.attr('data-window-id', 'palette');
    ...
    function toggleFloatingWindow() {
        if (floatingPaletteWindow) {
            if (floatingPaletteWindow.is(':visible')) {
                floatingPaletteWindow.hide();
            } else {
                floatingPaletteWindow.show();
            }
        }
    }
