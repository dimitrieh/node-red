...
RED.palette = (function() {
    ...
    function init() {
        ...
        // Add collapse/expand toggle button to palette
        $('<div class="red-ui-palette-collapse-toggle" title="Toggle Palette"><i class="fa fa-chevron-up"></i></div>').appendTo("#red-ui-palette");
        ...
        // Add palette collapse/expand functionality
        var paletteCollapsed = false;
        var paletteCollapseToggle = $(".red-ui-palette-collapse-toggle");
        paletteCollapseToggle.on("click", function(e) {
            e.preventDefault();
            ...
            if (paletteCollapsed) {
                ...
                paletteCollapseToggle.find("i").removeClass("fa-chevron-up").addClass("fa-chevron-down");
            } else {
                $("#red-ui-palette").removeClass("collapsed");
                $("#red-ui-main-container").css("top", "calc(var(--red-ui-header-height) + 200px)");
                paletteCollapseToggle.find("i").removeClass("fa-chevron-down").addClass("fa-chevron-up");
            }
        });
        
        RED.popover.tooltip(paletteCollapseToggle, "Toggle Palette Visibility");
        ...
        $(".red-ui-palette-resize-handle").on("mousedown", function(e) {
            ...
            $(document).on("mousemove.palette-resize", function(e) {
                ...
                var newHeight = Math.max(120, Math.min(400, startHeight + deltaY));
