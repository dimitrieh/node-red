...
RED.palette = (function() {
    ...
    function init() {
        ...
        if (RED.leftSidebar) {
            RED.leftSidebar.init();
        } else {
            // Fallback to original palette initialization
        ...
        var paletteSpinner = $("#red-ui-left-sidebar-palette-tab .red-ui-palette-spinner, #red-ui-palette > .red-ui-palette-spinner");
        paletteSpinner.show();
        ...
        // Add the sidebar controls to the main palette container (not inside tabs)
        sidebarControls = $('<div class="red-ui-sidebar-control-left"><i class="fa fa-chevron-left"></i></div>').prependTo($("#red-ui-palette"));
    ...
    function togglePalette(state) {
        if (!state) {
            ...
            // When palette is closed, adjust workspace position
            $("#red-ui-workspace").css("left", "8px");
            $("#red-ui-editor-stack").css("left", "8px");
        } else {
            ...
            // When palette is open, restore position based on current tab
            if (RED.leftSidebar) {
                var currentTab = RED.leftSidebar.getCurrentTab();
                if (currentTab === 'outliner') {
                    RED.leftSidebar.setPaletteWidth(280);
                } else {
                    RED.leftSidebar.setPaletteWidth(180);
                }
            } else {
                // Fallback to default width
                $("#red-ui-workspace").css("left", "181px");
                $("#red-ui-editor-stack").css("left", "181px");
            }
        }
