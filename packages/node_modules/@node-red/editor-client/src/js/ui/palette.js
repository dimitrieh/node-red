...
RED.palette = (function() {
    ...
    function init() {
        ...
        $('<div id="red-ui-palette-header"><div id="red-ui-palette-header-title">Node Palette</div><div id="red-ui-palette-minimize">−</div></div>').appendTo("#red-ui-palette");
        ...
        $("#red-ui-palette").draggable({
            handle: "#red-ui-palette-header",
            containment: "#red-ui-main-container"
        });

        // Add minimize functionality
        var isMinimized = false;
        $("#red-ui-palette-minimize").on("click", function(e) {
            e.preventDefault();
            e.stopPropagation();
            if (isMinimized) {
                $("#red-ui-palette").height('400px');
                $("#red-ui-palette-minimize").text('−');
                $("#red-ui-palette-container, #red-ui-palette-search, .red-ui-component-footer").show();
                isMinimized = false;
            } else {
                $("#red-ui-palette").height('30px');
                $("#red-ui-palette-minimize").text('+');
                $("#red-ui-palette-container, #red-ui-palette-search, .red-ui-component-footer").hide();
                isMinimized = true;
            }
        });
