...
RED.palette = (function() {
    ...
    function init() {
        ...
        paletteContent.append('<div id="red-ui-palette-search" class="red-ui-palette-search hide"><input type="text" data-i18n="[placeholder]palette.filter"></input></div>');
        paletteContent.append('<div id="red-ui-palette-container" class="red-ui-palette-scroll hide"></div>');
        paletteContent.append('<div class="red-ui-component-footer"></div>');
        paletteContent.append('<div id="red-ui-palette-shade" class="hide"></div>');
        
        // Hide the original palette container
        $("#red-ui-palette").hide();
        ...
        // Show spinner in the floating window content
