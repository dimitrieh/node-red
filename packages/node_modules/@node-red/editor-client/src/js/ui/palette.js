...
RED.palette = (function() {
    ...
    function init() {
        ...
        // Convert palette to floating window after initialization
        setTimeout(() => {
            convertPaletteToFloatingWindow();
        }, 100);
    }

    function convertPaletteToFloatingWindow() {
        if (typeof RED.floatingWindows !== 'undefined') {
            // Get the palette element
            const paletteElement = document.getElementById('red-ui-palette');
            if (paletteElement) {
                // Remove palette from its current position
                paletteElement.remove();
                
                // Create floating window for palette
                RED.floatingWindows.create('floating-palette', 'Node Palette', paletteElement, {
                    width: 200,
                ...
                // Initialize floating windows framework
