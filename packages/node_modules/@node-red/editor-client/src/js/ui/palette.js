...
RED.palette = (function() {
    ...
    function init() {
        ...
        $('<div class="red-ui-floating-header">' +
            '<div class="red-ui-floating-title">Node Palette</div>' +
            '<div class="red-ui-floating-controls">' +
                '<button class="red-ui-floating-button" id="red-ui-palette-minimize">−</button>' +
            '</div>' +
        '</div>').appendTo("#red-ui-palette");
        ...
        $("#red-ui-palette-minimize").on("click", function(e) {
            e.stopPropagation();
            $("#red-ui-palette").toggleClass("red-ui-floating-minimized");
            $(this).text($("#red-ui-palette").hasClass("red-ui-floating-minimized") ? "+" : "−");
        });
