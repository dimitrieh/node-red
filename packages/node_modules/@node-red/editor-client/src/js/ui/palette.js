...
RED.palette = (function() {
    ...
    function init() {
        ...
        // Add drag functionality for floating palette window
        let isDragging = false;
        let dragOffset = { x: 0, y: 0 };
        
        $("#red-ui-palette").on("mousedown", function(e) {
            // Only enable dragging if clicking on the title bar area (first 30px)
            if (e.offsetY <= 30) {
                isDragging = true;
                dragOffset.x = e.pageX - parseInt($("#red-ui-palette").css("left"));
                dragOffset.y = e.pageY - parseInt($("#red-ui-palette").css("top"));
