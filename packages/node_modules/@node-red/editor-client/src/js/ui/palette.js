...
RED.palette = (function() {
    ...
    function init() {
        // Add title bar for floating window
        var titleBar = $('<div class="red-ui-palette-title-bar">Node Palette<span class="red-ui-palette-minimize">−</span></div>').prependTo("#red-ui-palette");
        ...
        titleBar.on('mousedown', function(e) {
            if ($(e.target).hasClass('red-ui-palette-minimize')) return;
            isDragging = true;
            var paletteOffset = $("#red-ui-palette").offset();
            dragOffset.x = e.pageX - paletteOffset.left;
            dragOffset.y = e.pageY - paletteOffset.top;
            e.preventDefault();
        });
        ...
        titleBar.find('.red-ui-palette-minimize').on('click', function() {
            var palette = $("#red-ui-palette");
            if (palette.hasClass('minimized')) {
                palette.removeClass('minimized');
                palette.animate({height: '400px'}, 200);
                $(this).text('−');
            } else {
                palette.addClass('minimized');
                palette.animate({height: '30px'}, 200);
                $(this).text('□');
            }
        });
