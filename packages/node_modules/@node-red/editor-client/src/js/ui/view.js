    ...
    function init() {
        ...
        RED.events.on("workspace:change",function(event) {
            ...
            if (workspaceScrollPositions[event.workspace]) {
                ...
                // Center the canvas instead of starting at (0,0)
                var viewportWidth = chart.width();
                var viewportHeight = chart.height();
                var centerX = Math.max(0, (space_width * scaleFactor - viewportWidth) / 2);
                var centerY = Math.max(0, (space_height * scaleFactor - viewportHeight) / 2);
                chart.scrollLeft(centerX);
                chart.scrollTop(centerY);
            }
