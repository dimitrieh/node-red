...
RED.view = (function() {
    ...
    function init() {
        ...
        // Handle spacebar for grab-to-pan
        function handleSpacebarToggle(evt) {
            ...
            if (evt.keyCode === 32) { // Spacebar
                evt.preventDefault();
                var wasPressed = spacebarPressed;
                spacebarPressed = (evt.type === "keydown");

                // Update cursor style
                if (spacebarPressed && !wasPressed) {
                    outer.style("cursor", "grab");
                } else if (!spacebarPressed && wasPressed) {
                    // Reset cursor when spacebar is released
                    outer.style("cursor", "");
                    // If we were panning with spacebar, stop panning
    ...
    function canvasMouseUp() {
        ...
        if (mouse_mode === RED.state.PANNING) {
            resetMouseVars();
            // Reset cursor back to grab if spacebar is still pressed
            if (spacebarPressed) {
                outer.style("cursor", "grab");
            } else {
                outer.style("cursor", "");
