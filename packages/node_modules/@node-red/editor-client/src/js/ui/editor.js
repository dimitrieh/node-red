                ...
                },
                {
                    ...
                    click: function () {
                        ...
                        if (editState.changed) {
                            ...
                            RED.history.push(historyEvent);
                            if (RED.automerge && RED.automerge.isEnabled()) {
                                RED.automerge.updateNode(editingNode.id, RED.nodes.nodeToExportable(editingNode));
                            }
                            RED.nodes.dirty(true);
                        }
                ...
                },
                {
                    ...
                    click: function() {
                        ...
                        if (editState.changed) {
                            ...
                            RED.history.push(historyEvent);
                            if (RED.automerge && RED.automerge.isEnabled()) {
                                RED.automerge.updateNode(workspace.id, RED.nodes.nodeToExportable(workspace));
                            }
                            RED.nodes.dirty(true);
