...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        // Add drag functionality for floating sidebar window
        let isSidebarDragging = false;
        let sidebarDragOffset = { x: 0, y: 0 };
        
        $("#red-ui-sidebar").on("mousedown", function(e) {
            // Only enable dragging if clicking on the title bar area (first 30px)
            if (e.offsetY <= 30) {
                isSidebarDragging = true;
                sidebarDragOffset.x = e.pageX - parseInt($("#red-ui-sidebar").css("left"));
                sidebarDragOffset.y = e.pageY - parseInt($("#red-ui-sidebar").css("top"));
        ...
        $(document).on("mousemove", function(e) {
            if (isSidebarDragging) {
                $("#red-ui-sidebar").css({
                    left: e.pageX - sidebarDragOffset.x,
                    top: e.pageY - sidebarDragOffset.y
                });
                e.preventDefault();
            }
        });
