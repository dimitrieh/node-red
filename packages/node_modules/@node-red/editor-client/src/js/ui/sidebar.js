...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        // Create floating sidebar content (excluding debug)
        var sidebarContent = $('<div>');
        var tabsContainer = $('<ul id="red-ui-sidebar-tabs"></ul>').appendTo(sidebarContent);
        ...
        sidebar_tabs = RED.tabs.create({
            ...
            order: RED.settings.get("editor.sidebar.order",["info", "help", "version-control"])  // Remove debug from main sidebar
            // scrollable: true
        });
        ...
        var sidebarWindow = RED.floatingWindows.create({
            id: 'floating-sidebar',
            title: 'Sidebar',
        ...
        // Create separate floating debug window content
        var debugContent = $('<div>');
        $('<div id="red-ui-debug-content" class="debug-content"></div>').appendTo(debugContent);
        
        // Create floating debug window
        var debugWindow = RED.floatingWindows.create({
            id: 'floating-debug',
