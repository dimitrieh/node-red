...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        var titleBar = $('<div class="red-ui-sidebar-title-bar">Sidebar<span class="red-ui-sidebar-minimize">−</span></div>').prependTo("#red-ui-sidebar");
        ...
        titleBar.on('mousedown', function(e) {
            if ($(e.target).hasClass('red-ui-sidebar-minimize')) return;
            isDragging = true;
            var sidebarOffset = $("#red-ui-sidebar").offset();
            dragOffset.x = e.pageX - sidebarOffset.left;
            dragOffset.y = e.pageY - sidebarOffset.top;
            e.preventDefault();
        });
        ...
        titleBar.find('.red-ui-sidebar-minimize').on('click', function() {
            var sidebar = $("#red-ui-sidebar");
            if (sidebar.hasClass('minimized')) {
                sidebar.removeClass('minimized');
                sidebar.animate({height: '400px'}, 200);
                $(this).text('−');
            } else {
                sidebar.addClass('minimized');
                sidebar.animate({height: '30px'}, 200);
                $(this).text('□');
            }
        });
