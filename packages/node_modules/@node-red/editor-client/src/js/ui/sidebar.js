...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        // Add floating window header
        $('<div id="red-ui-sidebar-header"><div id="red-ui-sidebar-header-title">Sidebar</div><div id="red-ui-sidebar-minimize">−</div></div>').appendTo("#red-ui-sidebar");
        
        sidebar_tabs = RED.tabs.create({
            element: $('<ul id="red-ui-sidebar-tabs" class="red-ui-sidebar-tabs"></ul>').appendTo("#red-ui-sidebar"),
        ...
        $("#red-ui-sidebar").draggable({
            handle: "#red-ui-sidebar-header",
            containment: "#red-ui-main-container"
        });

        // Add minimize functionality
        var isMinimized = false;
        $("#red-ui-sidebar-minimize").on("click", function(e) {
            e.preventDefault();
            e.stopPropagation();
            if (isMinimized) {
                $("#red-ui-sidebar").height('400px');
                $("#red-ui-sidebar-minimize").text('−');
                $("#red-ui-sidebar-tabs, #red-ui-sidebar-content, #red-ui-sidebar-footer").show();
                isMinimized = false;
            } else {
                $("#red-ui-sidebar").height('30px');
                $("#red-ui-sidebar-minimize").text('+');
                $("#red-ui-sidebar-tabs, #red-ui-sidebar-content, #red-ui-sidebar-footer").hide();
                isMinimized = true;
            }
        });
