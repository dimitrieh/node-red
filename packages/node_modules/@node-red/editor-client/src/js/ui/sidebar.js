...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        $('<div class="red-ui-floating-header">' +
            '<div class="red-ui-floating-title">Sidebar</div>' +
            '<div class="red-ui-floating-controls">' +
                '<button class="red-ui-floating-button" id="red-ui-sidebar-minimize">−</button>' +
            '</div>' +
        '</div>').prependTo("#red-ui-sidebar");
        ...
        $("#red-ui-sidebar-minimize").on("click", function(e) {
            e.stopPropagation();
            $("#red-ui-sidebar").toggleClass("red-ui-floating-minimized");
            $(this).text($("#red-ui-sidebar").hasClass("red-ui-floating-minimized") ? "+" : "−");
        });
