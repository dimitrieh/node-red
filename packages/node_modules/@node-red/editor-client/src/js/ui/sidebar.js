...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        // Create the floating window for the sidebar
        ...
        sidebar_tabs = RED.tabs.create({
            ...
            onchange:function(tab) {
                ...
                // Update floating window title with active tab
                if (floatingWindow && tab.label) {
                    floatingWindow.setTitle(tab.label);
                }
            },
        ...
        var defaultX = Math.max(20, screenWidth - 350); // Position near right edge
