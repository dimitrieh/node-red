...
RED.sidebar = (function() {
    ...
    function init () {
        // Create floating sidebar container
        var sidebarContent = $('<div id="red-ui-sidebar"></div>');
        ...
        RED.windowManager.register('sidebar', sidebarWindow, {
            ...
            defaultHeight: '500px',
            shortcut: {
                action: 'core:toggle-sidebar-window'
            }
        });

        // Update toggle sidebar action to work with floating window
        RED.actions.add("core:toggle-sidebar",function(state){
            RED.windowManager.toggle('sidebar');
        });
