...
RED.sidebar = (function() {
    ...
    function addTab(title,content,closeable,visible) {
        ...
        options.wrapper = $('<div>',{style:"height:100%"}).appendTo(sidebarContent.find("#red-ui-sidebar-content"))
        ...
        if (options.toolbar) {
            sidebarContent.find("#red-ui-sidebar-footer").append(options.toolbar);
    ...
    function init () {
        ...
        // Create tabs structure inside floating window
        var tabsElement = $('<ul id="red-ui-sidebar-tabs"></ul>').appendTo(sidebarContent);
        sidebarContent.append('<div id="red-ui-sidebar-content"></div>');
        sidebarContent.append('<div id="red-ui-sidebar-footer" class="red-ui-component-footer"></div>');
        sidebarContent.append('<div id="red-ui-sidebar-shade" class="hide"></div>');
        
        // Hide the original sidebar container
        $("#red-ui-sidebar").hide();
        
        // Create floating window
        var windowId = RED.floatingWindows.create({
            id: 'sidebar-window',
            type: 'sidebar', 
            title: 'Info Sidebar',
            content: sidebarContent,
            x: window.innerWidth - 370, // Position at right edge
            y: 80,
            width: 350,
            height: 450
        });
