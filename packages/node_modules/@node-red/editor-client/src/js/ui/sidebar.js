...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        $('<div id="red-ui-sidebar-footer" class="red-ui-component-footer"></div>').appendTo(upperSection);
        ...
        $('<div id="red-ui-sidebar-debug-header"></div>').appendTo(lowerSection);
        ...
        $("#red-ui-sidebar-splitter").draggable({
            ...
            start: function(event, ui) {
                ...
                ui.helper.data('startPos', ui.position.top);
            },
            drag: function(event, ui) {
                var sidebarHeight = $("#red-ui-sidebar").height();
                var splitterHeight = $("#red-ui-sidebar-splitter").outerHeight();
                var minUpperHeight = 200;
                var minLowerHeight = 100;

                // Constrain position
                var maxPos = sidebarHeight - minLowerHeight - splitterHeight;
                var minPos = minUpperHeight;

                ui.position.top = Math.max(minPos, Math.min(maxPos, ui.position.top));

                // Update section heights
                $("#red-ui-sidebar-upper").css('flex', 'none').height(ui.position.top);
                $("#red-ui-sidebar-lower").height(sidebarHeight - ui.position.top - splitterHeight);
        ...
        if (savedHeight) {
            $("#red-ui-sidebar-lower").height(parseInt(savedHeight));
            var sidebarHeight = $("#red-ui-sidebar").height();
            var splitterHeight = $("#red-ui-sidebar-splitter").outerHeight();
            $("#red-ui-sidebar-upper").css('flex', 'none').height(sidebarHeight - parseInt(savedHeight) - splitterHeight);
        }
