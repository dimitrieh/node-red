...
RED.sidebar = (function() {
    ...
    function init () {
        ...
        // Skip setupSidebarSeparator() as we no longer need the separator
        ...
        // Create floating window for the sidebar
        var sidebarWindow = RED.floatingWindow.create({
            id: 'sidebar',
            title: 'Info Panel',
        ...
        RED.windowManager.register('sidebar', sidebarWindow, {
            title: 'Info Panel',
            visible: true,
            toggleable: true
        });
