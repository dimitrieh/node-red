...
module.exports = {
    init: function(_runtime) {
        ...
        // Initialize Automerge sync if collaborative editing is enabled
        if (runtime.settings.collaborativeEditing) {
            try {
                automergeSync = require('../automerge')
                automergeSync.init(runtime)
                runtime.log.info("Automerge collaborative editing initialized")
            } catch (err) {
                runtime.log.warn("Failed to initialize Automerge: " + err.message)
            }
        }
    ...
    /**
     * Get the Automerge sync module if available
     * @returns {Object|null} Automerge sync module or null
     */
    getAutomergeSync: function() {
     ...
     * @returns {boolean}
     */
    isCollaborativeEditingEnabled: function() {
        return automergeSync !== null && automergeSync.isEnabled()
    }
}