...
module.exports = {
    init: function(_settings, _runtimeAPI) {
        ...
        if (settings.collaborativeEditing) {
            if (!theme.multiplayer) theme.multiplayer = {};
            if (theme.multiplayer.enabled === undefined) theme.multiplayer.enabled = true;
        }
    ...
    app: function() {
        ...
        if (theme.header) {
            ...
            if (theme.header.hasOwnProperty("dashboardUrl")) {
                themeContext.header.dashboardUrl = theme.header.dashboardUrl;
            }
