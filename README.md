...
[Live Node-RED Experiments Dashboard](https://dashboard.tailbfedba.ts.net/)
...
**Note:** This repsitory is public but not interactable. Please reach out through the [official Node-RED issue tracker](https://github.com/node-red/node-red/issues) for any inquieries or feedback for now.
...
- Each live Node-RED instance has "sandbox mode" active for safe public demo access and gets an auto generated mini [Tally](https://tally.so/) survey embedded for instant feedback potential.
- The [dashboard](https://dashboard.tailbfedba.ts.net/) gets updated and deployed after every push as well + receives its own Tally survey as well.
